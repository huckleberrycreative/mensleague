-- Create tables for Gridiron Guild Admin CMS
...
-- 5. Playoff Statistics (aggregate stats)
...
-- 10. Pages (for managing static content)
...
CREATE INDEX idx_regular_season_standings_season ON regular_season_standings(season_id);
CREATE INDEX idx_regular_season_standings_team ON regular_season_standings(team_id);
CREATE INDEX idx_playoff_outcomes_season ON playoff_outcomes(season_id);
CREATE INDEX idx_playoff_outcomes_team ON playoff_outcomes(team_id);
CREATE INDEX idx_player_salaries_player ON player_salaries(player_id);
CREATE INDEX idx_player_salaries_team ON player_salaries(team_id);
